...
public class LocalTimeTest {
    ...
    public void test1() throws IOException {
        ...
        byte[] bytes = TLVBufferUtil.serializeNew(LocalTimeEntity.class, entity);

        LocalTimeEntity deserialized = TLVBufferUtil.deserializeNew(LocalTimeEntity.class, bytes);

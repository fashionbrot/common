...
public class JwtUtil {
     ...
     *
     */
    public static String encrypt(Algorithm sign,int expiredMinute,Map<String,Object> payload) {
        Date iatDate = new Date();
        // expire time
        Calendar nowTime = Calendar.getInstance();
        nowTime.add(CALENDAR_FIELD, expiredMinute);
    ...
    public static  <T> T get(Map<String, Claim> claimMap,String key, Class<T> requiredType,Class actualType) {
        if (claimMap.containsKey(key)) {
            ...
            if (claim != null) {
                ...
                }else if (JavaUtil.isCollection(requiredType)){
                    return (T) claim.asList(actualType);
